...
class AdvancedPronunciationDetector:
    ...
    def __init__(self):
        ...
        # Common words to skip - these are NOT pronunciation errors
        # They may have low confidence or match patterns but are common/easy words
        self.skip_words = {
            # Function words
            ...
            # Common simple words that get false positives
            'where', 'there', 'here', 'well', 'just', 'also', 'very', 'really', 'actually',
            'getting', 'headed', 'started', 'looking', 'working', 'trying', 'going',
            'about', 'over', 'after', 'before', 'into', 'with', 'from', 'than', 'then',
            'because', 'since', 'while', 'during', 'through', 'between', 'under',
            'again', 'still', 'already', 'always', 'never', 'ever', 'often', 'sometimes',
            'now', 'today', 'tomorrow', 'yesterday', 'week', 'month', 'year',
            'all', 'both', 'each', 'every', 'some', 'any', 'many', 'much', 'more', 'most',
            'other', 'another', 'same', 'different', 'such', 'only', 'own', 'even',
            'new', 'old', 'good', 'bad', 'great', 'best', 'better', 'first', 'last',
            'long', 'little', 'big', 'small', 'high', 'low', 'right', 'wrong', 'sure',
            'keep', 'kept', 'put', 'let', 'start', 'stop', 'end', 'help', 'try', 'tried',
            'feel', 'felt', 'find', 'found', 'give', 'gave', 'tell', 'told', 'ask', 'asked',
            'work', 'play', 'run', 'walk', 'talk', 'call', 'meet', 'read', 'write', 'turn',
            'move', 'live', 'leave', 'left', 'stay', 'stand', 'sit', 'lie', 'lay',
            'open', 'close', 'show', 'shown', 'hear', 'heard', 'listen', 'watch', 'wait',
            'bring', 'brought', 'buy', 'bought', 'pay', 'paid', 'sell', 'sold', 'send', 'sent',
            'hold', 'held', 'break', 'broke', 'build', 'built', 'set', 'cut', 'hit', 'hurt',
            'lose', 'lost', 'win', 'won', 'spend', 'spent', 'lead', 'led', 'fall', 'fell',
            'grow', 'grew', 'throw', 'threw', 'catch', 'caught', 'teach', 'taught',
            'speak', 'spoke', 'choose', 'chose', 'begin', 'began', 'become', 'became',
            'understand', 'understood', 'remember', 'forget', 'forgot', 'happen', 'happened',
            'seem', 'seemed', 'appear', 'change', 'changed', 'follow', 'followed',
            'include', 'included', 'continue', 'continued', 'consider', 'considered',
            # Words from the transcript that are NOT mispronounced
            'hopping', 'logged', 'project', 'headed', 'fair', 'keeping', 'real', 'sounds',
            'review', 'process', 'things', 'getting', 'messy', 'hear', 'anyone', 'burning',
            'deadline', 'move', 'alright', 'plan', 'clean', 'clear', 'crystal', 'yeah',
            'something', 'feeling', 'early', 'turns', 'bigger', 'issue', 'cool', 'locked',
            'energy', 'touch', 'base', 'perfect', 'both', 'overall', 'gonna', 'parts',
            'team', 'line', 'crazy', 'exactly', 'revisions', 'overlap', 'feels', 'hard',
            'lock', 'best', 'honestly', 'effort', 'fried', 'time', 'would', 'easier',
            'stressed', 'reason', 'makes', 'without', 'doing', 'updates', 'ready',
            'agree', 'workload', 'itself', 'drops', 'once', 'throws', 'vibe', 'harder',
            'focused', 'straight', 'green', 'mode', 'fine', 'term', 'solid', 'structure',
            'track', 'moving', 'rear', 'expectations', 'schedule', 'when', 'reacting',
            'bit', 'morale', 'grid',  # More false positives to skip
        }
