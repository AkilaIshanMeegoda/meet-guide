...
class PhonemePronunciationDetector:
    ...
    # Common words to skip (function words, short common words, etc.)
    SKIP_WORDS = {
        ...
        # Common short words that are NOT pronunciation challenges
        'bad', 'bit', 'got', 'get', 'let', 'set', 'put', 'cut', 'run',
        'big', 'new', 'old', 'one', 'two', 'way', 'day', 'man', 'out',
        'good', 'back', 'look', 'come', 'give', 'take', 'make', 'know',
        'think', 'work', 'feel', 'keep', 'want', 'need', 'mean', 'tell',
        'start', 'stay', 'turn', 'move', 'show', 'help', 'call', 'find',
        'straight', 'going', 'getting', 'doing', 'being', 'having',
        'hopping', 'locked', 'sounds', 'because', 'morale', 'grid',
        'rear', 'everything', 'something', 'anything', 'nothing',
        'everyone', 'someone', 'anyone', 'overall', 'actually',
        'exactly', 'revisions', 'productive', 'expectations',
    }
