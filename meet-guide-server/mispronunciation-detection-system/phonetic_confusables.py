"""
==============================================================================
PHONETIC CONFUSABLES AND MISPRONUNCIATION PATTERN DETECTOR
==============================================================================

This module detects potential mispronunciations by identifying:
1. Words that were likely INTENDED to be different words based on phonetic similarity
2. Common L2 (second language) English pronunciation error patterns
3. Context-based corrections where ASR transcribed an unlikely word

Key insight: When ASR transcribes "checking" but the speaker likely meant "check-in" 
and mispronounced it as "cheeking", this module detects that pattern.

The approach:
1. Build phonetic representations of transcribed words
2. Compare against vocabulary of contextually likely words
3. Use known mispronunciation patterns to flag potential errors
4. Consider context to improve detection accuracy
...
# =============================================================================
# PHONETIC REPRESENTATION USING METAPHONE/SOUNDEX-LIKE ALGORITHM
# =============================================================================
...
# =============================================================================
# DYNAMIC MISPRONUNCIATION PATTERNS
# =============================================================================
# NOTE: This module no longer uses hardcoded word patterns.
# Mispronunciation detection is now done dynamically by comparing:
# 1. MFA phoneme alignments (what was actually pronounced)
# 2. CMU dictionary expected phonemes (standard pronunciation)
# 
# The PhoneticEncoder class below provides phonetic similarity calculations
# that can be used to compare any two words dynamically.
# =============================================================================

# Empty dictionaries - patterns are now detected dynamically
